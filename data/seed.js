...
(function (sitegear3) {
	...
	sitegear3.ready(function () {
		...
		var app = sitegear3().initialise(require('../settings.json')).persistence('filesystem', { root: __dirname }),
			pageCollection = app.storage.define('page'),
			productItemCollection = app.storage.define('productItem'),
			productCategoryCollection = app.storage.define('productCategory');
